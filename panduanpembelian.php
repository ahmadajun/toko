			...
			<div class="col-md-9">
				<div class="card">
					<div class="card-body">
						...
						<p class="b"><b>4. </b> Jika sudah sesuai dengan produk yang ingin anda pesan, langkah selanjutnya, masukan jumlah yang ingin anda pesan dan langkah selanjutnya masukan ke keranjang.</p>
						<center><img class="thumbnail" width="800" id="gambar" src="img-panduan/menu.png" alt=""></center>
						<p class="b"><b>5. </b> Didalam halaman keranjang anda dapat melihan pilihan produk yang anda pesan, jika anda ingin membeli lebih dari satu produk anda bisa klik Lanjutkan Belanja, jika tidak langsung saja dengan mengklik tombol Checkout untuk melakukan transaksi pesanan anda!</p>
						<center><img class="thumbnail" width="800" id="gambar" src="img-panduan/keranjang.png" alt=""></center>
						<p class="b"><b>6. </b> Pada halaman checkout silahkan lihat apakah pesanan anda sudah benar, jika sudah benar selanjutnya silahkan mengisi data ekspedisi yang akan digunakan, total belanja anda akan dijumlahkan sesuai dengan jarak pengiriman ke rumah anda.</p>
						...
						<p class="b"><b>8. </b> Pada halaman cara pembayaran anda akan diberitahu jumlah pembayaran yang harus dibayar, dan transfer ke salah satu rekening Luumode Store!</p>
						<center><img class="thumbnail" width="800" id="gambar" src="img-panduan/pembayaran.png" alt=""></center>
						<p class="b"><b>9. </b> Jika anda sudah membayar sesuai dengan pesanan, tahap selanjutnya silahkan klik tombol saya sudah bayar pada halaman bawah menu cara pembayaran. Maka anda akan dialihkan ke halaman unggah bukti pembayaran dengan memasukan jumlah yang anda transfer dan upload bukti struk transfer, anda juga akan mendapatkan notifikasi pesanan update tiap proses!</p>
						...
						<br>
						<p id="a"><b>Konsultasi</b> - Jika anda bingung bagaimana cara pemesanan, silahkan anda bisa hubungi CS melalui whatsapp. Anda juga dapat memberikan kritik dan saran yang membangun untuk toko kami.</p><br>
						<div class="row">
