            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="stok_produk" class="form-control" placeholder="Stoks produk" required="">
                                </div>
                                <div class="form-group col-md-6">
                        ...
                        {
                            $hasil = $produk->add($_POST['id_kategori'],$_POST['nama_produk'],$_POST['harga_produk'],$_POST['berat_produk'],$_POST['stok_produk'],$_FILES['gambar_produk'],$_POST['deskripsi_produk']);
                            if ($hasil=="sukses") 
                            {
