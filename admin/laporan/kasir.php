...
$bulan=$_GET['bulan'];
$tahun=$_GET['tahun'];
$data=$laporan->kasir($bulan,$tahun);
...
<body>
  <div id='contentwrapper' class='contentwrapper'>
    <div id="judul">
      ...
      <font size="+2"><u>LAPORAN TRANSAKSI OFFLINE</u></font><br /><br />
        ...
        <table class="table table-striped table-bordered">
          ...
          <thead>
            <tr>
              ...
              <th><i class='icon-signal'></i> Pelanggan</th>              <th><i class='icon-signal'></i> Subtotal</th>
            </tr>
          </thead>
          <tbody>
            <?php if (empty($data)): ?>
