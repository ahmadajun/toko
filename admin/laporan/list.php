...
<div class="col-xl-6">
  <div class="card">
    <div class="card-body">
     <h5 class="text-center">Laporan Transaksi Pelanggan <br> Pertahun</h5>
     <hr>
...
<div class="col-xl-6">
  <div class="card">
    <div class="card-body">
     <h5 class="text-center">Laporan Transaksi Supplier <br> Perbulan</h5>
     <hr>
...
<div class="col-xl-6">
  <div class="card">
    <div class="card-body">
     <h5 class="text-center">Laporan Transaksi Supplier <br> Pertahun</h5>
     <hr>
...
<div class="col-xl-6">
  ...
  <div class="card">
    <div class="card-body">
      ...
      <hr>
      <form action="laporan/return.php" target="_blank">
        <button class="btn btn-primary btn-block"><i class="fa fa-print"></i> CETAK</button>
      </form>
    </div>
  </div>
