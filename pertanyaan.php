			...
			<div class="col-md-9">
				<div class="card">
					<div class="card-body">
						...
						<h4>Bagaimana cara tahu bahwa barang yang saya cari masih ada stoknya atau sudah habis ?</h4>
						<p>Untuk informasi ketersediaan stok, silahkan cari barang tersebut ditempat pencarian yang telah disediakan. Bila ditemukan, klik pada barang tersebut untuk melihat detail info. Pada halaman detail produk, akan tertera informasi ketersediaan barang tersebut.</p><br>
						<h4>Bagaimana cara pembayarannya ?</h4>
						<p>Untuk saat ini kami menerima pembayaran dengan metode Transfer antar Bank. Kami memiliki rekening bank Mandiri. Untuk informasi nomor rekening akan muncul pada saat proses pembayaran pada sistem, untuk  lebih jelasnya bisa ditanyakan melalui Whatsapp kami. Karena kami menggunakan kurir untuk melakukan pengiriman, maka kami meminta pembayaran harus dilakukan terlebih dahulu (sebelum barang pesanan kami kirim kepada Anda).</p><br>
					</div>
				</div>
			</div>
